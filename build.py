...
def footer():
    ...
    <div class="footer-inner">
      ...
      <div class="footer-col">
        ...
        <p>{tri(ADDRESS_LO, ADDRESS_EN, ADDRESS_VI)}</p>
...
MENU = [
    ("ເຂົ້າຈານ (ອາຫານຕາມສັ່ງ)", "Rice Plates", "Cơm đĩa", [
        dict(id="pad-krapao-crispy-pork-rice", lo="ເຂົ້າຜັດກະເພົາໝູກຮອບ + ໄຂ່ດາວ", en="Stir-fried Crispy Pork Pad Krapao + fried egg, with rice", vi="Cơm thịt heo giòn xào lá quế + trứng ốp la", kind="simple", price=50000, note=tri("(ໄຂ່ດາວເພີ່ມ +7,000 kip)", "(extra fried egg +7,000 kip)", "(thêm trứng ốp la +7,000 kip)")),
        dict(id="pad-krapao-rice", lo="ເຂົ້າຜັດກະເພົາ (ໝູ/ໄກ່/ທະເລ) + ໄຂ່ດາວ", en="Pad Krapao pork/chicken/seafood + fried egg, with rice", vi="Cơm thịt băm xào lá quế (heo/gà/hải sản) + trứng ốp la", kind="variant",
             variants=[("ໝູ", "Pork", "Heo", 45000), ("ໄກ່", "Chicken", "Gà", 45000), ("ທະເລ", "Seafood", "Hải sản", 50000)],
        ...
        dict(id="morning-glory-rice", lo="ເຂົ້າຜັກບົ້ງໄຟແດງ", en="Stir-fried Morning Glory, with rice", vi="Cơm rau muống xào", kind="simple", price=40000),
        dict(id="lao-omelette-rice", lo="ເຂົ້າໄຂ່ຈຽວ", en="Lao Omelette, with rice", vi="Cơm trứng chiên kiểu Lào", kind="simple", price=40000),
    ...
    ("ສະປາເກັຕິ", "Spaghetti", "Mì Ý (Spaghetti)", [
        ...
        dict(id="carbonara-spaghetti", lo="ສະປາເກັຕິ ຄາໂບນາລາ", en="Carbonara Spaghetti", vi="Spaghetti Carbonara", kind="simple", price=50000),
    ]),
    ...
    ("ຂອງກິນຫຼີ້ນ ແລະ ຂອງທອດ", "Snacks & Fried Sides", "Món ăn chơi & chiên (không kèm cơm)", [
        ...
        dict(id="mixed-veg-side", lo="ຂົ້ວຜັກລວມ", en="Stir-fried Mixed Vegetables (no rice)", vi="Rau củ xào thập cẩm (dùng riêng, không cơm)", kind="simple", price=60000),
    ...
    ("ອ່ອມ ແລະ ຕົ້ມ", "Soups", "Canh & Súp", [
        ...
        dict(id="clear-soup-tofu-pork", lo="ຕົ້ມຈືດ", en="Clear Soup with Tofu and Minced Pork", vi="Canh trong đậu hũ thịt băm", kind="simple", price=50000),
